...
public class MainActivity extends AppCompatActivity {
    ...
    public void fillMyList(){
        ...
        myList.add(new Person("Carlos Jimenez","Student"));
        myList.add(new Person("Manfred Artavia","Student"));
        myList.add(new Person("Kenneth Perez","Student"));
        myList.add(new Person("Deiber Gonzalez","Student"));
        myList.add(new Person("Jonathan Rojas","Student"));
        myList.add(new Person("Carlos Solis","Student"));
        myList.add(new Person("Daniel Mauricio","Student"));
        myList.add(new Person("Joaquin Andres","Student"));
        myList.add(new Person("Eder Naranjo","Student"));
        myList.add(new Person("Keylor Rojas","Student"));
        myList.add(new Person("Jose Guerrero","Student"));
    }
